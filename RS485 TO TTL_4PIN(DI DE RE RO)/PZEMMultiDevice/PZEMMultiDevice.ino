...
#define PZEM_RX_PIN 12 //Revise
#define PZEM_TX_PIN 13 //Revise
#endif

#if !defined(PZEM_SERIAL)
#define PZEM_SERIAL Serial //Revise
#endif

#define NUM_PZEMS 3  //Revise
...
void setup() {
    ...
    for(int i = 0; i < NUM_PZEMS; i++)
    {
        ...
        pzems[i] = PZEM004Tv30(pzemSWSerial, 0x30 + i);
#elif defined(ESP32)
        // Initialize the PZEMs with Hardware Serial2 on RX/TX pins 16 and 17
        pzems[i] = PZEM004Tv30(PZEM_SERIAL, PZEM_RX_PIN, PZEM_TX_PIN, 0x30 + i);
#else
        ...
        */
        pzems[i] = PZEM004Tv30(PZEM_SERIAL, 0x30 + i);
#endif
    }
}
